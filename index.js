...
/***/ function(module, exports, __webpack_require__) {
	...
	var getClasses = function(time) {
	    var query = 'section_classes?start_time=eq.' + timeSelect.value +
	        ':30:00' + '&day_of_week=eq.' + dayOfWeekLookup[d] + '&term_start=eq.2016-01-04&select= location,sections{id,courses{id,number,title,description,subjects{*}}}'
	    console.log(query)
